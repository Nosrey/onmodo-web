    ...
    <>
      <div>
        <div className='form'>
          ...
          {showModal ? (
            <Modal content={<EppInfo />} closeModal={() => setShowModal(false)} />
          ) : (
          ...
          <div className={styles.personal}>
            <TextField
              onChange={(e) => {
                setValues({ ...values, nombreEmpleado: e.target.value });
              }}
              id='outlined-basic'
            ...
            <TextField
              onChange={(e) => {
                setValues({ ...values, sector: e.target.value });
              }}
              id='outlined-basic'
              label='Sector'
              variant='outlined'
            ...
            <TextField
              disabled
              onChange={(e) => {
                setValues({ ...values, puesto: e.target.value });
              }}
              id='outlined-basic'
              label='Puesto'
              variant='outlined'
          ...
          <div className='contMonthTable'>
            ...
            <div className='tableSectionCheck'>
              <div className='tableRowCheckTitle'>
                <span className='dayTitle'>1</span>
                <span className='dayTitle'>2</span>
                <span className='dayTitle'>3</span>
                <span className='dayTitle'>4</span>
                <span className='dayTitle'>5</span>
                <span className='dayTitle'>6</span>
                <span className='dayTitle'>7</span>
                <span className='dayTitle'>8</span>
                <span className='dayTitle'>9</span>
                <span className='dayTitle'>10</span>
                <span className='dayTitle'>11</span>
                <span className='dayTitle'>12</span>
                <span className='dayTitle'>13</span>
                <span className='dayTitle'>14</span>
                <span className='dayTitle'>15</span>
                <span className='dayTitle'>16</span>
                <span className='dayTitle'>17</span>
                <span className='dayTitle'>18</span>
                <span className='dayTitle'>19</span>
                <span className='dayTitle'>20</span>
                <span className='dayTitle'>21</span>
                <span className='dayTitle'>22</span>
                <span className='dayTitle'>23</span>
                <span className='dayTitle'>24</span>
                <span className='dayTitle'>25</span>
                <span className='dayTitle'>26</span>
                <span className='dayTitle'>27</span>
                <span className='dayTitle'>28</span>
                <span className='dayTitle'>29</span>
                <span className='dayTitle'>30</span>
                <span className='dayTitle'>31</span>
              </div>
              {renglones.map((_, index) => (
                <div className='tableRowCheck' key={index}>
                  {checks.map((input) => (
                    <div key={input.id}>
                      <Checkbox
                        onChange={(e) => {
                          checkboxValuesConstructor(index, e.target.checked, input.id);
                        }}
                        className='check'
          ...
          <div className='btn'>
            <Button
              onClick={async () => {
                await axios.post('https://api.onmodoapp.com/api/entregaropa', {
                  ...values,
