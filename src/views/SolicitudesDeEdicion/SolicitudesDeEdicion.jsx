...
function SolicitudesDeEdicion() {
  ...
  async function getData() {
    getSolicitudesDeEdicion().then((resp)=> {   
        const result = [];
      ...
      />
        ...
        <div className={styles.container}>
                      <div className={styles.wrapper}>
                          ...
                          <ModalEdicionRespuesta openModal={openModal} setOpenModal={setOpenModal} idForm={formSelected && formSelected.id} urlForm={formSelected && formSelected.urlForm} showAlert={(type, msg) => showAlertNotif(type, msg)} motivo={formSelected && formSelected.motivoPeticion? formSelected.motivoPeticion : null}/>
                      </div>
                  </div></>)}
