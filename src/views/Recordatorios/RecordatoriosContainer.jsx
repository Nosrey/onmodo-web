...
const DATA_RECORDATORIOS = [
  {
    tarea: '2',
    descripcion:
      'Es neceario limpiar los tanques dos veces al año . Para esto es necesario utilizar los productos detallados en la documentación adjunta y los elementos de protección necesarios.',
  ...
  },
  {
    tarea: '5',
    descripcion:
      'Es necesario pintar las rejas del edificio utilizando pintura sintética color negro. No olvidar icluir antioxidante.',
    link: 'https://www.google.com',
